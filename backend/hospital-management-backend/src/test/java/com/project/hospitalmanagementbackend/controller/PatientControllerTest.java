...
public class PatientControllerTest {
    ...
    @Test
    public void testGetAllPatientsWithRequests() {
    	...
    	when(patientService.getPatientsWithFacilityRequests()).thenReturn(patientList);
    	assertEquals(patientController.getAllPatientsWithRequests(),new ResponseEntity<>(patientList, HttpStatus.OK));
    }
