...
public class HospitalFacilityController {
	...
	public ResponseEntity<?> addHospitalFacility
	(@RequestBody HospitalFacility hospitalFacility,@PathVariable("hospitalId") String hospitalId,@PathVariable("facilityId") long facilityId){
		return new ResponseEntity<>(hospitalFacilityService.addHospitalFacility(hospitalFacility,hospitalId,facilityId),HttpStatus.OK);
	}
